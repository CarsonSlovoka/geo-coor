...
project = 'Geographic Coordinate'  # project_name
pypi_project_name = 'geo-coor'
...
if 'my setting':
    ...
    if 'Disqus':
        disqus_short_name = pypi_project_name
        disqus_url_root = f'https://carsonslovoka.github.io/{disqus_short_name}/{language}'
